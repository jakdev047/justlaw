...
<head>
	...
	<!-- Custom stlylesheet -->
	<link type="text/css" rel="stylesheet" href="{{asset('frontend/css/styleshom.css')}}" />
	...
	<div class="section">
		...
		<div class="container">
			...
			<div class="row">
                ...
                @php
                    $deals_product = DB::select('SELECT * FROM product WHERE product_position = "deals" ');
                @endphp
                                ...
                                <div class="product product-single">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-btns">
                                            ...
                                            <a href="{{url('add-to-cart/'.$item->id) }}" class="primary-btn add-to-cart">
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="product product-single product-hot">
						<div class="product-thumb">
							...
							<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
							<img src="{{asset('frontend/img/product01.jp')}}g" alt="">
						</div>
						<div class="product-body">
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="product product-single">
						<div class="product-thumb">
							...
							<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
							<img src="{{asset('frontend/img/product02.jp')}}g" alt="">
						</div>
						<div class="product-body">
							<h3 class="product-price">$32.50 <del class="product-old-price">$45.00</del></h3>
							<div class="product-rating">
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="product product-single">
						<div class="product-thumb">
							...
							<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
							<img src="{{asset('frontend/img/product07.jp')}}g" alt="">
						</div>
						<div class="product-body">
							<h3 class="product-price">$32.50 <del class="product-old-price">$45.00</del></h3>
							<div class="product-rating">
